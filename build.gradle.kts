    ...
    sourceSets {
        ...
        val jsMain by getting {
            dependencies {
                ...
                implementation(project.dependencies.enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:0.0.1-pre.246-kotlin-1.5.30"))
        ...
        val jvmTest by getting {
            dependencies {
                ...
                implementation("com.amazonaws:aws-java-sdk-core:1.12.66") // testcontainers need it
            }
        }
    }
}
