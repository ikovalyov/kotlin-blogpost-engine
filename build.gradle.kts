    ...
    sourceSets {
            ...
            dependencies {
                ...
                implementation(
                    project.dependencies.enforcedPlatform(
                        "org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:0.0.1-pre.262-kotlin-1.5.31"
                    )
                )
        ...
        val jvmMain by getting {
            dependencies {
                ...
                implementation(project.dependencies.enforcedPlatform("io.micronaut:micronaut-bom:3.1.3"))
        ...
        val jvmTest by getting {
            dependencies {
                ...
                implementation("com.amazonaws:aws-java-sdk-core:1.12.101") // testcontainers need it
            }
        }
    }
}
